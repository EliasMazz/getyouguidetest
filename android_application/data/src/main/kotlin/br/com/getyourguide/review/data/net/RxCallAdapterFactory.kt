...
class RxCallAdapterFactory private constructor() : Factory() {
    ...
    companion object {
        fun create(): CallAdapter.Factory = RxCallAdapterFactory()
    }
    ...
    override fun get(returnType: Type, annotations: Array<Annotation>, retrofit: Retrofit): CallAdapter<*, *>? {
        ...
        if (rawType == Completable::class.java) {
            return RxCallAdapter<Completable>(retrofit, adapter, rawType)
        }

        return RxCallAdapter<Observable<*>>(retrofit, adapter, rawType)
    }
}
